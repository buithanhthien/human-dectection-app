...
def generate_launch_description():
    ...
    start_sync_view_robot_pkg_node = LifecycleNode(
        parameters=[
          slam_params_file,
          {
    ...
    configure_event = EmitEvent(
        event=ChangeState(
            lifecycle_node_matcher=matches_action(start_sync_view_robot_pkg_node),
    ...
    activate_event = RegisterEventHandler(
        OnStateTransition(
            target_lifecycle_node=start_sync_view_robot_pkg_node,
    ...
    ld.add_action(start_sync_view_robot_pkg_node)
